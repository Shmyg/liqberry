window["WIDGETKIT_URL"] = "/new/media/widgetkit";

function wk_ajax_render_url(widgetid) {
		return "/new/component/widgetkit/?format=raw&id=" + widgetid
	}
	(function(g, f) {
		var a = {};
		f.$widgetkit = {
			lazyloaders: {},
			load: function(b) {
				a[b] || (a[b] = g.getScript(b));
				return a[b]
			},
			lazyload: function(a) {
				a = a || document;
				g("[data-widgetkit]", a).each(function() {
					var a = g(this),
						b = a.data("widgetkit"),
						c = a.data("options") || {};
					!a.data("wk-loaded") && $widgetkit.lazyloaders[b] && ($widgetkit.lazyloaders[b](a, c), a.data("wk-loaded", !0))
				})
			}
		};
		g(function() {
		...
		for (var b = document.createElement("div"), c = b.style, b = !1, d = ["-webkit-", "-moz-", "-o-", "-ms-", "-khtml-"], e = ["Webkit", "Moz", "O", "ms", "Khtml"], j = "", h = 0; h < e.length; h++)
			if ("" === c[e[h] + "Transition"]) {
				b = e[h] + "Transition";
				j = d[h];
				break
		...
		$widgetkit.prefix = j;
		c = $widgetkit;
		b = (d = b) && "WebKitCSSMatrix" in window && "m11" in new WebKitCSSMatrix && !navigator.userAgent.match(/Chrome/i);
		...
		$widgetkit.css3 = function(a) {
			a = a || {};
			a.transition && (a[j + "transition"] = a.transition);
			a.transform && (a[j + "transform"] = a.transform);
			a["transform-origin"] && (a[j + "transform-origin"] = a["transform-origin"]);
			return a
		};
		if (!(b = g.browser)) c = navigator.userAgent, c = c.toLowerCase(), b = {}, c = /(chrome)[ \/]([\w.]+)/.exec(c) || /(webkit)[ \/]([\w.]+)/.exec(c) || /(opera)(?:.*version)?[ \/]([\w.]+)/.exec(c) || /(msie) ([\w.]+)/.exec(c) || 0 > c.indexOf("compatible") && /(mozilla)(?:.*? rv:([\w.]+))?/.exec(c) || [], b[c[1]] = !0, b.version = c[2] || "0";
		g.browser = b;
		b = null
	})(jQuery, window);
(function(g) {
	...
	a: {
		try {
			f = parseInt(navigator.appVersion.match(/MSIE (\d\.\d)/)[1], 10);
			break a
		} catch (a) {}
		f = !1
	}
	f && 9 > f && (g(document).ready(function() {
		g("body").addClass("wk-ie wk-ie" + f)
	}), g.each("abbr article aside audio canvas details figcaption figure footer header hgroup mark meter nav output progress section summary time video".split(" "), function() {
...
(function(g, f) {
	f.$widgetkit.trans = {
		...
		get: function(a) {
			...
			var b = 1 == arguments.length ? [] : Array.prototype.slice.call(arguments, 1);
			return this.printf(String(this.__data[a]), b)
		},
		printf: function(a, b) {
			if (!b) return a;
			var c = "",
			...
			for (var e = 0; e < b.length; e++) d[e].lastIndexOf("%") == d[e].length - 1 && e != b.length - 1 && (d[e] += "s" + d.splice(e + 1, 1)[0]), c += d[e] + b[e];
			return c +
				d[d.length - 1]
		}
	}
...
(function(g) {
	...
	g.extend(g.easing, {
		...
		easeInElastic: function(f, a, b, c, d) {
			...
			if (1 == (a /= d)) return b + c;
			e || (e = 0.3 * d);
			g < Math.abs(c) ? (g = c, f = e / 4) : f = e / (2 * Math.PI) * Math.asin(c / g);
			return -(g * Math.pow(2, 10 * (a -= 1)) * Math.sin((a * d - f) * 2 * Math.PI / e)) + b
		},
		easeOutElastic: function(f, a, b, c, d) {
			...
			e || (e = 0.3 * d);
			g < Math.abs(c) ? (g = c, f = e / 4) : f = e / (2 * Math.PI) * Math.asin(c / g);
			return g * Math.pow(2, -10 * a) * Math.sin((a * d - f) * 2 * Math.PI / e) + c + b
		},
		easeInOutElastic: function(f, a, b, c, d) {
			...
			e || (e = d * 0.3 * 1.5);
			g < Math.abs(c) ? (g = c, f = e / 4) : f = e / (2 * Math.PI) * Math.asin(c / g);
			return 1 > a ? -0.5 * g * Math.pow(2, 10 * (a -= 1)) * Math.sin((a * d - f) * 2 * Math.PI / e) + b : 0.5 * g * Math.pow(2, -10 * (a -= 1)) * Math.sin((a * d - f) * 2 * Math.PI / e) + c + b
		},
		easeInBack: function(f, a, b, c, d, e) {
			void 0 == e && (e = 1.70158);
			return c * (a /= d) * a * ((e + 1) * a - e) + b
		},
		easeOutBack: function(f, a, b, c, d, e) {
			void 0 == e && (e = 1.70158);
			return c * ((a = a / d - 1) * a * ((e + 1) * a + e) + 1) + b
		},
		easeInOutBack: function(f, a, b, c, d, e) {
			void 0 == e && (e = 1.70158);
			return 1 > (a /= d / 2) ? c / 2 * a * a * (((e *= 1.525) + 1) * a - e) + b : c / 2 * ((a -= 2) * a * (((e *= 1.525) + 1) * a + e) + 2) + b
		},
		easeInBounce: function(f, a, b, c, d) {
			return c - g.easing.easeOutBounce(f, d - a, 0, c, d) + b
		},
		easeOutBounce: function(f, a, b, c, d) {
		...
		easeInOutBounce: function(f, a, b, c, d) {
			return a < d / 2 ? 0.5 * g.easing.easeInBounce(f, 2 * a, 0, c, d) + b : 0.5 * g.easing.easeOutBounce(f, 2 * a - d, 0, c, d) + 0.5 * c + b
		}
	})
})(jQuery);
(function(g) {
	function f(a) {
		...
		d.unshift(a, e, f, h);
		return g.event.handle.apply(this, d)
	}
	var a = ["DOMMouseScroll", "mousewheel"];
	g.event.special.mousewheel = {
		setup: function() {
			if (this.addEventListener)
				for (var b = a.length; b;) this.addEventListener(a[--b], f, !1);
			else this.onmousewheel = f
		},
		teardown: function() {
			if (this.removeEventListener)
				for (var b = a.length; b;) this.removeEventListener(a[--b], f, !1);
...
(function(g) {
	...
	f.ajaxupload = a;
	g.support.ajaxupload && g.event.props.push("dataTransfer");
	g.fn.uploadOnDrag = function(a) {
		return !g.support.ajaxupload ? this : this.each(function() {
			var c = g(this),
				b = g.extend({
					action: "",
					single: !1,
			...
			c.on("drop", function(a) {
				function c(a, b) {
					for (var d = new FormData, e = new XMLHttpRequest, f = 0, h; h = a[f]; f++) d.append("files[]", h);
					for (var l in b.params) d.append(l, b.params[l]);
					e.upload.addEventListener("progress", function(a) {
						b.progress(100 * (a.loaded / a.total), a)
					}, !1);
					...
					e.open(b.method, b.action, !0);
					e.onreadystatechange = function() {
						b.readystatechange(e);
						if (4 == e.readyState) {
				...
				if (b.single) {
					var f = a.dataTransfer.files.length,
						e = 0,
						j = b.complete;
					b.complete = function(a, g) {
						e += 1;
						j(a, g);
						e < f ? c([d[e]], b) : b.allcomplete()
					};
					c([d[0]], b)
				} else c(d, b)
	...
	if (!g.event.special.debouncedresize) {
		var b = g.event,
			c, d;
		c = b.special.debouncedresize = {
			setup: function() {
				g(this).on("resize", c.handler)
			},
			teardown: function() {
				g(this).off("resize", c.handler)
			},
			handler: function(a, f) {
				var g = this,
					...
					k = function() {
						...
						b.dispatch.apply(g, m)
					};
				d && clearTimeout(d);
				f ? k() : d = setTimeout(k, c.threshold)
			},
			threshold: 150
		}
	}
...
(function(d) {
	var a = function() {};
	a.prototype = d.extend(a.prototype, {
		name: "accordion",
		options: {
			index: 0,
			duration: 500,
		...
		initialize: function(a, b) {
			var b = d.extend({}, this.options, b),
				c = a.find(b.toggler),
				g = function(a) {
					var f = c.eq(a).hasClass("active") ? d([]) : c.eq(a),
						e = c.eq(a).hasClass("active") ? c.eq(a) : d([]);
					f.hasClass("active") && (e = f, f = d([]));
					b.collapseall && (e = c.filter(".active"));
					switch (b.animated) {
						case "slide":
							f.next().stop().show().animate({
								height: f.next().data("height")
							}, {
								easing: b.easing,
								duration: b.duration
							});
			...
			c.each(function(a) {
				var c = d(this).bind(b.event, function() {
						g(a)
					}),
					e = c.next().css("overflow", "hidden").addClass("content-wrapper");
				a == b.index || "all" == b.index ? (c.addClass("active"), e.show()) : e.hide().css("height", 0)
			});
			j();
	...
	d.fn[a.prototype.name] = function() {
		...
		return this.each(function() {
			var c = d(this);
			if (a.prototype[b] && c.data(a.prototype.name) && "initialize" != b) c.data(a.prototype.name)[b].apply(c.data(a.prototype.name), Array.prototype.slice.call(h, 1));
...
if (!window['mejs']) {
	$widgetkit.load('/new/media/widgetkit/widgets/mediaplayer/mediaelement/mediaelement-and-player.js').done(function() {
		jQuery(function($) {
			mejs.MediaElementDefaults.pluginPath = '/new/media/widgetkit/widgets/mediaplayer/mediaelement/';
			$('video,audio').each(function() {
				var ele = $(this);
				if (!ele.parent().hasClass('mejs-mediaelement')) {
					ele.data('mediaelement', new mejs.MediaElementPlayer(this, {
						"pluginPath": "\/new\/media\/widgetkit\/widgets\/mediaplayer\/mediaelement\/"
					}));
...
$widgetkit.load('/new/media/widgetkit/widgets/spotlight/js/spotlight.js').done(function() {
	jQuery(function($) {
